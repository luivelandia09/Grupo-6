export default function Valores() {
  return (
    <div className="font-[Montserrat] text-[#495057] bg-[#f8f9fa] leading-relaxed">
      ...
      {/* SECCIÓN PRINCIPAL */}
      <section className="py-16 bg-gradient-to-br from-[#e6f2ff] to-white">
      ...
      {/* FORMULARIO */}
      <section className="py-16 bg-gradient-to-br from-white to-[#e6f2ff]">
      ...
      {/* FOOTER */}
      <footer className="bg-[#64bafb] text-black py-10 mt-10">
        <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <img src="/src/assets/img/logo.png" alt="Logo FARMAVEN" className="h-20 mb-3" />
            <p className="text-sm">
